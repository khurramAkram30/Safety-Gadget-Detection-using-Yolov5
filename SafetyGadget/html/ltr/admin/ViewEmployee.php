  ...
  <div class="main-menu menu-fixed menu-light menu-accordion" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="reports.php"><i class="ft-airplay"></i><span class="menu-title" data-i18n="">Report</span></a>
        </li>
      </ul>
    </div>
  </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered mb-0">
                  ...
                  <tbody>
                    ...
                    <?php
                      echo "<tr>";
                      echo "<td>" . $employee["_id"] . "</td>";
                      echo "<td>" . $employee["name"] . "</td>";
                      echo "<td>" . $employee["email"] . "</td>";
                      echo "<td>" . $employee["age"] . "</td>";
                      echo "<td>" . $employee["dob"] . "</td>";
                      echo "<td><a class='btn btn-success' href='update.php?empid=".$employee["_id"]."'>Edit</a></td>";
                      echo "<td><a class='btn btn-danger' href='Delete.php?empid=".$employee["_id"]."'>Delete</a></td>";
...
<script>
  fetch("http://localhost:8000/allEmploye")
.then(response => {
  ...
  $(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        // console.log(data.employees.length-1);
